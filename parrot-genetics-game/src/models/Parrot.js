// ChromaWing - Parrot Model
// v3.0

import { BODY_PARTS, RARITY_MULTIPLIERS } from '../data/constants.js';
import { getNextParrotId } from '../game/gameState.js';

export class Parrot {
    constructor(name, genes, generation = 1, id = null) {
        this.id = id !== null ? id : getNextParrotId();
        this.name = name;
    ...
    getValue() {
        ...
        return Math.floor(baseValue * RARITY_MULTIPLIERS[rarity]);
    }
